...
from miniproject_grades import*
...
def display():
    ...
    # give total credits for grade S
    if e4.get() == "S":
    ...
    # give total credits for grade C
    if e4.get() == "C":
    ...
    if e9.get() == "S":
        ...
        tot += 20
    if e9.get() == "A":
        tk.Label(master, text="18").grid(row=8, column=4)
        tot += 18
    if e9.get() == "B":
        tk.Label(master, text="16").grid(row=8, column=4)
        tot += 16
    if e9.get() == "C":
        tk.Label(master, text="14").grid(row=8, column=4)
        tot += 14
    if e9.get() == "D":
        tk.Label(master, text="12").grid(row=8, column=4)
        tot += 12
    if e9.get() == "F":
    ...
    # to display SGPA
    tk.Label(master, text=str(tot / 22)).grid(row=10, column=4)
...
tk.Label(master, text=str(e0)).grid(row=0, column=1)

#label for srn
tk.Label(master, text="SRN").grid(row=1, column=0)
tk.Label(master, text=str(e1)).grid(row=1, column=1)

# label for roll number
tk.Label(master, text="Roll.No").grid(row=0, column=3)
tk.Label(master, text=str(e2)).grid(row=0, column=4)

# label for registration Number
tk.Label(master, text="Reg.No").grid(row=1, column=3)
tk.Label(master, text=str(e3)).grid(row=1, column=4)
...
tk.Label(master, text="MA 101").grid(row=3, column=1)
tk.Label(master, text="EC 101").grid(row=4, column=1)
tk.Label(master, text="CY 101").grid(row=5, column=1)
tk.Label(master, text="CS 101").grid(row=6, column=1)
tk.Label(master, text="CV 101").grid(row=7, column=1)
tk.Label(master, text="CE 101").grid(row=8, column=1)
...
tk.Label(master, text="2").grid(row=8, column=3)

tk.Label(master, text="Credit obtained").grid(row=2, column=4)

# taking entries of name,srn, roll, reg number respectively
...
tk.Label(master, text="Total credit").grid(row=9, column=3)
tk.Label(master, text="SGPA").grid(row=10, column=3)
